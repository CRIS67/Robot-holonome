        ...
        <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
				<li>
                <a href="robot.php"><i class="fas fa-robot fa-fw"></i> <?php echo _("Robot Dashboard"); ?></a>
              </li>
              <li>
                <a href="index.php?page=wlan0_info"><i class="fa fa-dashboard fa-fw"></i> <?php echo _("Wifi Dashboard"); ?></a>
              </li>
              <li>
